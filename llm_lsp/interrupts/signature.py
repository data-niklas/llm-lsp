...
class SignatureInterrupt(InterruptType):
    ...
    def create_comment(self, signature_help: Any, code_util: CodeUtil) -> Optional[Comment]:
        ...
        comment += "Provide as few arguments as possible and as many as needed. Provide arguments as positional arguments instead of as named arguments if possible. Often times optional arguments can be omitted."
